...
void *HiddenNeuroneTask ( void *ptr ) {
	...
	while (1) {
		...
		pthread_barrier_wait(&(barrier_CalculFini));
		...
		pthread_barrier_wait(&(barrier_TrainFini));
...
int main(int argc, char *argv[]) {
	...
	pthread_barrier_init(&barrier_CalculFini, NULL, numTask+1);
	pthread_barrier_init(&barrier_TrainFini, NULL, numTask+1);
...
GET_TSC(t2);
	...
	pthread_barrier_destroy(&barrier_CalculFini);
	pthread_barrier_destroy(&barrier_TrainFini);
