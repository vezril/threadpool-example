...
pthread_mutex_t mutex_CalculeNet = PTHREAD_MUTEX_INITIALIZER;
pthread_cond_t  cond_CalculeNet  = PTHREAD_COND_INITIALIZER;
int				CalculeNet = 0;
pthread_mutex_t mutex_TrainNet   = PTHREAD_MUTEX_INITIALIZER;
pthread_cond_t  cond_TrainNet    = PTHREAD_COND_INITIALIZER;
int				TrainNet = 0;

sem_t 	sem_CalculFini;
sem_t 	sem_TrainFini;
int		Fini = 0;

float		LearnRate, Momentum;
float		Reponse, NetErreur, TotalErreur, TErreur, FErreur;
float		NetErreurRcv, TotalErreurRcv, TErreurRcv, FErreurRcv;
